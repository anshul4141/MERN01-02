...
const CartPage = () => {
    ...
    const handleGooglePaySuccess = async (paymentData) => {
        try {
            ...
            const { data } = await axios.post(`http://localhost:5000/product/googlepay/payment`, {
                token,
                cart,
            });
            setLoading(false);
    ...
    const handleRazorpayPayment = async () => {
        try {
            ...
            const { data: order } = await axios.post(`http://localhost:5000/product/razorpay/create-order`, { amount });
            ...
            const options = {
                ...
                handler: async (response) => {
                    ...
                    const verificationResponse = await axios.post(`http://localhost:5000/product/razorpay/verify`, verificationPayload);
